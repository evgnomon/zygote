...
Zygote is a handy runtime for developing cloud functions, essentially the building blocks of apps. Guided by the principle "No human is let in the factory", the function code gets seamlessly integrated using Zygote CI/CD which is offered as a service and could be added to your Github repo as an Application. This ensures we can get a function up and running "without entering the factory". Zygote is freely available under HGL License.
