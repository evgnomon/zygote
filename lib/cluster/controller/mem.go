...
import (
	...
	"github.com/evgnomon/zygote/lib/cluster/memconn"
...
func NewRedisQueryController(config *RedisConfig) (*RedisQueryController, error) {
	...
	ep, err := memconn.MemEndpoints(utils.NetworkName(), utils.DomainName(), 2, targetReadPort)
